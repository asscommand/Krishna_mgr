...
$$ |$$  / $$ |  $$ |  $$ |  $$ /  \__|$$ |  $$ |$$$$\ $$ |$$ /  $$ |      $$$$\  $$$$ |$$ /  $$ |$$ /  \__|$$ /  $$ |$$ |  $$ |
$$$$$  /  $$$$$$$  |  $$ |  \$$$$$$\  $$$$$$$$ |$$ $$\$$ |$$$$$$$$ |      $$\$$\$$ $$ |$$$$$$$$ |$$ |$$$$\ $$$$$$$$ |$$$$$$$  |
$$  $$<   $$  __$$<   $$ |   \____$$\ $$  __$$ |$$ \$$$$ |$$  __$$ |      $$ \$$$  $$ |$$  __$$ |$$ |\_$$ |$$  __$$ |$$  __$$< 
$$ |\$$\  $$ |  $$ |  $$ |  $$\   $$ |$$ |  $$ |$$ |\$$$ |$$ |  $$ |      $$ |\$  /$$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |
$$ | \$$\ $$ |  $$ |$$$$$$\ \$$$$$$  |$$ |  $$ |$$ | \$$ |$$ |  $$ |      $$ | \_/ $$ |$$ |  $$ |\$$$$$$  |$$ |  $$ |$$ |  $$ |
\__|  \__|\__|  \__|\______| \______/ \__|  \__|\__|  \__|\__|  \__|      \__|     \__|\__|  \__| \______/ \__|  \__|\__|  \__| \u001b[31mv4
\033[1;37m----------------------------------------------
 AUTHOR     : KRISHNA MAGAR
 GITHUB     : KRISHNA MAGAR
 FACEBOOK   : Krishna Magar
		...
		if len(vin)==0:
			...
			for isi in vin:
				...
				if cih<10:
					...
					linex()
					print(' '+nom+'. '+isi+'\033[31m '+str(len(hem))+' \033[KRISHNA CP '+x)
				else:
					lol.update({str(cih):str(isi)})
					print(' '+str(cih)+'. '+isi+'\033[31m '+str(len(hem))+' \033[KRISHNA CP '+x)
			linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[KRISHNA-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
